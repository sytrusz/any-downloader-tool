...
if %errorlevel% neq 0 (
    if not exist "%PYTHON_DIR%\python.exe" (
        ...
        :: Enable 'import site' so pip works in the embeddable Python
...
if "%PYTHON_EXE%"=="python" (
    :: If using system python, we use a virtual environment to avoid polluting their system
    if not exist ".venv" (
    ...
    :: If using portable python, it's already isolated, no venv needed
